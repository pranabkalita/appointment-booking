<div class="bg-white rounded-lg">
    <div class="flex items-center justify-center relative">
        ...
        <div class="text-lg font-semibold p-4">{{ $this->calendarStartDate->format('M Y') }}</div>
    ...
    <div class="flex justify-between items-center px-3 border-b border-gray-200 p-2">
